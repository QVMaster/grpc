...
{
    /// <summary>
    /// Provides the common functionality for client interceptors that want to add hooks that run before and after a call is executed.
    /// This is an EXPERIMENTAL API.
    /// </summary>
    public abstract class ClientHooksInterceptor
    {
	protected virtual void PreInvoke<TRequest, TResponse>(Method<TRequest, TResponse> method, string host, CallOptions options, TRequest request)
	    where TRequest : class,
	    where TResponse : class
        {
	}

	protected virtual void PostInvoke<TRequest, TResponse>(
        /// <summary>
