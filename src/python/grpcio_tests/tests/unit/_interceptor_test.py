...
class _Interceptor(grpc.ServerInterceptor):
    ...
    def intercept_service(self, handler_call_details, continuation):
        self.record.append(self.tag + ':intercept_handler')
...
class InterceptorTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._server = grpc.server(self._server_pool,
            interceptors=(_Interceptor('s1', self._record),
                          _Interceptor('s2', self._record),))
    ...
    def testInterceptedUnaryRequestBlockingUnaryResponse(self):
        ...
        self.assertSequenceEqual(self._record,
            ['s1:intercept_handler', 's2:intercept_handler'])
